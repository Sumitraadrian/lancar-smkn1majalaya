...
$query = "SELECT * FROM pengajuan  WHERE status = 'pending' ORDER BY id ASC";
...
.alasan-column {
        width: 30%; /* Expand "Alasan" column */
    }

    .tanggal-column {
        width: 13%; /* Decrease width for "Tanggal Mulai" and "Tanggal Akhir" columns */
    }
                    ...
                    <table id="dispensasiTable" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>NIS</th>
                                <th>Kelas</th>
                                <th class="alasan-column">Alasan</th> <!-- Apply class to "Alasan" column -->
                                <th class="tanggal-column">Tanggal Mulai Dispensasi</th> <!-- Apply class to "Tanggal Mulai" column -->
                                <th class="tanggal-column">Tanggal Akhir Dispensasi</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($row['status'] == 'pending'): ?>
                                        <span class="status-badge status-belum-diproses">Belum ACC</span>
